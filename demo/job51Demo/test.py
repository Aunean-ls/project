...
c = (
    ...
    # )
        ...
        .set_global_opts(title_opts=opts.TitleOpts(title="Bar-参数使用例子"), # toolbox_opts=opts.ToolboxOpts(),
                         yaxis_opts=opts.AxisOpts(position="right", name="Y轴"), # datazoom_opts=opts.DataZoomOpts(),
                         )
